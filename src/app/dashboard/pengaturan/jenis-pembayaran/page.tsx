...
import { ArrowLeft, CreditCard, Plus, Edit2, Trash2, X, Save } from 'lucide-react';
import Link from 'next/link';

export default function JenisPembayaranPage() {
  const [data, setData] = useState([
    { id: '1', nama: 'Uang Komite', nominal: 250000, tipe: 'Bulanan' },
    { id: '2', nama: 'Uang Pangkal / PNB', nominal: 3500000, tipe: 'Sekali Bayar' },
    { id: '3', nama: 'Seragam Sekolah', nominal: 1500000, tipe: 'Sekali Bayar' },
    { id: '4', nama: 'Buku Paket', nominal: 850000, tipe: 'Tahunan' },
  ]);
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <span className="text-[12px] font-medium text-gray-400">Rp {item.nominal.toLocaleString('id-ID')}</span>
          ...
          <div className="w-full max-w-md bg-[#1c1c1e] rounded-3xl border border-white/10 shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="p-6 space-y-5">
               ...
               <div className="space-y-2">
                 ...
                 <select 
                   defaultValue={editingItem?.tipe || 'Bulanan'}
                 ...
                 >
                   ...
                   <option value="Sekali Bayar">Sekali Bayar (Selama Sekolah)</option>
                 </select>
               </div>
            </div>
            ...
            <div className="px-6 py-4 border-t border-white/5 flex gap-3 bg-white/[0.02]">
              ...
              <button 
                onClick={handleCloseModal}
                className="flex-1 py-3 rounded-xl font-bold text-[14px] text-white bg-purple-600 hover:bg-purple-500 transition-colors flex justify-center items-center gap-2 shadow-lg shadow-purple-600/30"
              >
                <Save size={16} />
                Simpan
              </button>
